        ...
        <main class="sheet">
            <header class="report-header">
                ...
                <div class="document-code" aria-label="Document details">
                    <div><span>Report</span><strong>REG</strong></div>
            ...
            <section class="meta-grid" aria-label="Report information">
                <div class="meta-item meta-item--wide">
                    ...
                    <span class="meta-value">Single registration record</span>
                </div>
                <div class="meta-item">
    ...
    @else
        ...
        <main class="sheet">
            ...
            <section class="report-title">
                ...
                <p>All matching registrations</p>
            </section>

            <section class="meta-grid" aria-label="Report information">
                <div class="meta-item meta-item--wide">
                    <span class="meta-label">Report Scope</span>
                    <span class="meta-value">All matching registration records</span>
                </div>
                <div class="meta-item">
                    <span class="meta-label">Generated By</span>
                    <span class="meta-value">{{ auth()->user()->username ?? auth()->user()->email ?? 'System' }}</span>
